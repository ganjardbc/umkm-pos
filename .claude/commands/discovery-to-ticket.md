...
`.claude/agents/pm.md` § Tools yang Diizinkan) — mengubah dokumen discovery jadi ticket adalah
...
- Kalau `$ARGUMENTS` kosong: `ls -t .ai/discovery/` untuk lihat folder yang ada.
