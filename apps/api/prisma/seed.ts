...
async function main() {
  ...
  const permissionsData = [
    ...
    { code: 'products.view', description: 'View product detail' },
    // Category management
    { code: 'categories.create', description: 'Create product categories' },
    { code: 'categories.read', description: 'Read product categories' },
    { code: 'categories.update', description: 'Update product categories' },
    { code: 'categories.delete', description: 'Delete product categories' },
    // Transactions
