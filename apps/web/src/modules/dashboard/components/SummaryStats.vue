  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    <UiCard class="bg-white dark:bg-dark-secondary! rounded-lg shadow">
      <div class="flex justify-between items-center">
        ...
        <div class="w-12 h-12 flex justify-center items-center bg-blue-50 dark:bg-blue-950/30 rounded-lg text-blue-600 dark:text-blue-400">
    ...
    <UiCard class="bg-white dark:bg-dark-secondary! rounded-lg shadow">
      <div class="flex justify-between items-center">
        ...
        <div class="w-12 h-12 flex justify-center items-center bg-green-50 dark:bg-green-950/30 rounded-lg text-green-600 dark:text-green-400">
    ...
    <UiCard class="bg-white dark:bg-dark-secondary! rounded-lg shadow">
      <div class="flex justify-between items-center">
        ...
        <div class="w-12 h-12 flex justify-center items-center rounded-lg bg-red-50 dark:bg-red-950/30 text-red-600 dark:text-red-400">
    ...
    <UiCard class="bg-white dark:bg-dark-secondary! rounded-lg shadow">
      <div class="flex justify-between items-center">
        ...
        <div class="w-12 h-12 flex justify-center items-center bg-purple-50 dark:bg-purple-950/30 rounded-lg text-purple-600 dark:text-purple-400">
