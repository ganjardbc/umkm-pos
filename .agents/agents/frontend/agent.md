...
**Description:** Implementasi Vue 3 module mengikuti konvensi proyek. Output: kode + verify-report.md. Gunakan untuk "implement frontend TICKET-ID", "scaffold web module", "frontend agent". Baca requirements.md + design.md dari .ai/tasks/TICKET-ID/ sebelum mulai.
