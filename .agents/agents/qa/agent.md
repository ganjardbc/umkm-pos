...
**Description:** Test mendalam setelah implementasi selesai. Cek edge case, boundary, error path. Output: qa-report.md di .ai/tasks/TICKET-ID/. Gunakan untuk "QA TICKET-ID", "test this feature", "qa agent".
