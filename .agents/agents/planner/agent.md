...
**Description:** Baca ticket/task dan buat rencana tertulis. Output: requirements.md + tasks.md di .ai/tasks/TICKET-ID/. JANGAN sentuh kode. Gunakan untuk "plan TICKET-ID", "buat rencana untuk X", "planner agent".

**Capabilities:** Read, Write, WebFetch
