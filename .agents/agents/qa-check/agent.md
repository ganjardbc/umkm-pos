...
Kalau `.agents/agents/qa/agent.md` ada, baca dan ikuti sebagai sumber
kebenaran utama untuk checklist dan format output. Kalau tidak ada, gunakan
default:
