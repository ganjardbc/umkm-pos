...
**Description:** Implementasi NestJS module mengikuti konvensi proyek. Output: kode + verify-report.md. Gunakan untuk "implement backend TICKET-ID", "scaffold API module", "backend agent". Baca requirements.md + design.md dari .ai/tasks/TICKET-ID/ sebelum mulai.
