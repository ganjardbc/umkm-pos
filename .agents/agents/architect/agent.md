...
**Description:** Tentukan pendekatan teknis untuk task kompleks. Output: design.md di .ai/tasks/TICKET-ID/. Opsional — gunakan hanya untuk task yang melibatkan schema baru, multi-service, atau keputusan arsitektur non-trivial. Gunakan untuk "architect TICKET-ID", "design this", "technical approach for X".

**Capabilities:** Read, Write
**Recommended model:** high-reasoning (setara Opus) — keputusan kompleks
