...
**Description:** Jalankan Auditor Agent scan read-only terhadap scope tertentu, hasilkan dokumen temuan (tidak membuat ticket). Argumen: scope, contoh "apps/api/src/modules/rbac" atau "semua modul".
...
`.agents/agents/auditor/agent.md` — kalau file itu ada, baca dan patuhi isinya
