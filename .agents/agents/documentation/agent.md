...
**Description:** Update docs/ setelah implementasi selesai — paralel, tidak blocking pipeline. Update api-contract.md, database-design.md, frontend-routes.md sesuai perubahan. Gunakan untuk "update docs TICKET-ID", "documentation agent".

**Capabilities:** Read, Write, Edit
**Recommended model:** low-tier (setara Haiku) — task dokumentatif
...
- **Jangan ubah:** Kode aplikasi, schema, agent artifacts di `.ai/tasks/`

## Input

```
.ai/tasks/<TICKET-ID>/verify-report.md   — apa yang berubah
...
- Model kecil (Haiku-tier) cukup untuk task dokumentatif — jangan minta model besar
