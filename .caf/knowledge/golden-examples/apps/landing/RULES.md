# Golden Examples — RULES.md (@umkm-pos/landing)
...
|---|---|---|
| `apps/landing/src/components/HeroSection.vue` | Component | TODO |
| `apps/landing/src/composables/useLocale.ts` | Composable/Hook | TODO |
